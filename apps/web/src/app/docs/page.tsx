...
export default function DocsIntroPage() {
  return (
    <>
      {/* Middle Column: Documentation Content */}
      <div className="flex-1 w-full max-w-4xl mx-auto px-margin-mobile md:px-margin-desktop py-lg overflow-y-auto">
        <header className="mb-lg">
          <h1 className="font-display-lg text-display-lg text-on-surface mb-sm">
            Introduction
          </h1>
          <p className="font-body-lg text-body-lg text-on-surface-variant max-w-3xl leading-relaxed">
            Welcome to the 9jaPrice API. Our API provides programmatic access to real-time
            and historical food price data across major Nigerian markets.
          </p>
        </header>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-sm">
            ...
            >
              ...
              <p className="font-body-sm text-body-sm text-on-surface-variant">
                Browse endpoints, parameters, and interactive examples in our API Explorer.
              </p>
            </Link>
            ...
            >
              ...
              <p className="font-body-sm text-body-sm text-on-surface-variant">
                Test API calls directly from your browser without writing any code.
              </p>
            </Link>
          </div>
        </section>
      ...
      <aside className="w-full lg:w-[400px] xl:w-[480px] bg-surface-container border-l border-outline-variant p-margin-mobile md:p-margin-desktop overflow-y-auto">
        <div className="sticky top-lg">
          ...
          <div className="bg-[#1E293B] rounded-lg overflow-hidden border border-[#334155] shadow-[0_4px_12px_rgba(0,0,0,0.1)] mb-0">
            <div className="flex items-center justify-between px-4 py-2 border-b border-[#334155] bg-[#0F172A]">
              <span className="font-data-mono text-[12px] text-[#E2E8F0]">cURL</span>
          ...
          <div className="bg-[#1E293B] rounded-lg overflow-hidden border border-[#334155] shadow-[0_4px_12px_rgba(0,0,0,0.1)]">
            <div className="flex items-center justify-between px-4 py-2 border-b border-[#334155] bg-[#0F172A]">
              <span className="font-data-mono text-[12px] text-[#E2E8F0]">JSON</span>
            </div>
  ...
  `}
                  ...
                  {`: {\n    `}
                  <span className="text-[#7DD3FC]">&quot;commodity_id&quot;</span>
                  {`: `}
                  <span className="text-[#8df8b7]">&quot;rice-50kg&quot;</span>
                  {`,\n    `}
                  <span className="text-[#7DD3FC]">&quot;market_name&quot;</span>
                  {`: `}
                  <span className="text-[#8df8b7]">&quot;Mile 12 Market&quot;</span>
                  {`,\n    `}
                  <span className="text-[#7DD3FC]">&quot;current_price_ngn&quot;</span>
                  {`: `}
                  <span className="text-[#FBBF24]">75000</span>
                  {`,\n    `}
                  <span className="text-[#7DD3FC]">&quot;price_change_24h&quot;</span>
                  {`: `}
                  <span className="text-[#EF4444]">-1.5</span>
                  {`,\n    `}
                  <span className="text-[#7DD3FC]">&quot;timestamp&quot;</span>
                  {`: `}
                  <span className="text-[#8df8b7]">&quot;2024-05-20T14:30:00Z&quot;</span>
                  {`\n  }\n}`}
                </code>
              </pre>
            </div>
